...
int main(int argc, char **argv)
{
  ...
  {
  i=i+1;
  speed1.base=TCPvelocity1.data[0];
  speed1.shoulder=TCPvelocity1.data[1];
  speed1.elbow=TCPvelocity1.data[2];
  speed1.wrist1=TCPvelocity1.data[3];
  speed1.wrist2=TCPvelocity1.data[4];
  speed1.wrist3=TCPvelocity1.data[5];
  arm->setJointSpeeds(speed1, 0.1, 0.1);
